...
- **deps**: Update dependency sqlalchemy to v2.0.54
  ([#143](https://github.com/bartekmp/MediCony/pull/143),
  [`c79064b`](https://github.com/bartekmp/MediCony/commit/c79064b8cc7b0b9c5fdcb4db3c5941fb910a5335))
...
- **deps**: Update dependency sqlalchemy to v2.0.53
  ([#142](https://github.com/bartekmp/MediCony/pull/142),
  [`fd6006a`](https://github.com/bartekmp/MediCony/commit/fd6006a6bc1c50d8a43171899c0136193f4e7b19))
...
- **deps**: Update python dependencies ([#139](https://github.com/bartekmp/MediCony/pull/139),
  [`d745979`](https://github.com/bartekmp/MediCony/commit/d7459796cc171f0be05d14e0acff22cad19a15b5))
...
- **deps**: Update python dependencies ([#135](https://github.com/bartekmp/MediCony/pull/135),
  [`6929bab`](https://github.com/bartekmp/MediCony/commit/6929bab9150930323d391926c7bc8bfc52984ed7))
...
- **deps**: Update dependency sqlalchemy to v2.0.52
  ([#132](https://github.com/bartekmp/MediCony/pull/132),
  [`9a1d6de`](https://github.com/bartekmp/MediCony/commit/9a1d6de36f35b9bdb89b5842cd56fc7f7af97929))
...
- **deps**: Update dependency numpy to v2.5.2
  ([#131](https://github.com/bartekmp/MediCony/pull/131),
  [`c30c5fe`](https://github.com/bartekmp/MediCony/commit/c30c5fe13c473cd3faade4c37510cd5af4f24bb1))
...
- **deps**: Update dependency cryptography to v50
  ([#129](https://github.com/bartekmp/MediCony/pull/129),
  [`e5a1421`](https://github.com/bartekmp/MediCony/commit/e5a14211b536fcbab9e457921f91d222b3cd79c1))
...
- **deps**: Update python dependencies ([#125](https://github.com/bartekmp/MediCony/pull/125),
  [`092c5a5`](https://github.com/bartekmp/MediCony/commit/092c5a5a1536d0b7bcd8f6796ac1f0bab5d4b51b))
...
- **deps**: Update python dependencies ([#124](https://github.com/bartekmp/MediCony/pull/124),
  [`f7096f5`](https://github.com/bartekmp/MediCony/commit/f7096f52574755bf9ad1769326f34d9e47241279))
...
- **deps**: Update python dependencies ([#120](https://github.com/bartekmp/MediCony/pull/120),
  [`4774acc`](https://github.com/bartekmp/MediCony/commit/4774accdbbe595ab24c2b57358ed642345960527))
...
- **deps**: Update python dependencies ([#117](https://github.com/bartekmp/MediCony/pull/117),
  [`ba6c748`](https://github.com/bartekmp/MediCony/commit/ba6c748c88847ef333733a9b84b5573fc2aadc29))
...
- **deps**: Update python dependencies ([#113](https://github.com/bartekmp/MediCony/pull/113),
  [`b0a71a2`](https://github.com/bartekmp/MediCony/commit/b0a71a28364244b21054b0d92d2656ff2ddd5cfb))
...
- **deps**: Update python dependencies to v3.29.0
  ([#112](https://github.com/bartekmp/MediCony/pull/112),
  [`4c054d9`](https://github.com/bartekmp/MediCony/commit/4c054d95ab89df8632f2e42676627c97da9067e3))
...
- **deps**: Update python dependencies to v48.0.1
  ([#110](https://github.com/bartekmp/MediCony/pull/110),
  [`ddff6bf`](https://github.com/bartekmp/MediCony/commit/ddff6bf2e6095b71af07132468fed5f935360730))
...
- **deps**: Update python dependencies to v4.15.0
  ([#108](https://github.com/bartekmp/MediCony/pull/108),
  [`42a55c9`](https://github.com/bartekmp/MediCony/commit/42a55c963ea2ab8dcacea924426b591e58cbf0ab))
...
- **deps**: Update python dependencies to v1.4.0
  ([#105](https://github.com/bartekmp/MediCony/pull/105),
  [`984e9dc`](https://github.com/bartekmp/MediCony/commit/984e9dc9d935fdbbff073221bf0e0ad01578e003))
...
- **deps**: Update dependency numpy to v2.4.6
  ([#103](https://github.com/bartekmp/MediCony/pull/103),
  [`7747ceb`](https://github.com/bartekmp/MediCony/commit/7747ceb70f39489ce2f951c42337a6794d7c9b99))
...
- **deps**: Update python dependencies ([#100](https://github.com/bartekmp/MediCony/pull/100),
  [`d0f154b`](https://github.com/bartekmp/MediCony/commit/d0f154be2c6c5ce6d8c845f6bfa6cc14d60b9988))
...
- Update dependency cryptography to v48 ([#96](https://github.com/bartekmp/MediCony/pull/96),
  [`b7ca812`](https://github.com/bartekmp/MediCony/commit/b7ca8121b1c350334a0393d9047e9abfe27d17ca))
...
- **deps**: Update dependency aiogram to v3.28.1
  ([#98](https://github.com/bartekmp/MediCony/pull/98),
  [`129fed9`](https://github.com/bartekmp/MediCony/commit/129fed9df3c7dbde4ade4321faa47dcbc802a1f4))
...
- **deps**: Update python dependencies ([#97](https://github.com/bartekmp/MediCony/pull/97),
  [`56cc53b`](https://github.com/bartekmp/MediCony/commit/56cc53b42762ad4e723ed55c9f636d0fb8d71a23))
